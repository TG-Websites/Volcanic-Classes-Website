...
function renderAnnouncements(containerId, announcements) {
    ...
    announcements.forEach(item => {
        const dateObj = new Date(item.createdAt); // or item.createdAt if your API uses that
    ...
    classes.forEach(item => {
        ...
        <div class="flex items-start border-b pb-3 update-item">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 border-2 rounded-full px-2">
